...
if __name__ == "__main__":
    ...
    from easyAI import (AI_Player, Human_Player, Negamax, DictTT, 
                         solve_game )
    
    
    # we first solve the game
    w,d,m,tt = solve_game(Nim, range(5,20), win_score=80)
    print w,d, len(tt.d)
    ...
    # Note that with the transposition table tt generated by solve_game
